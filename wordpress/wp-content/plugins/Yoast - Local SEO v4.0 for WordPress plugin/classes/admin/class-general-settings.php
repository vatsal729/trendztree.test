...
if ( ! class_exists( 'WPSEO_Local_Admin_General_Settings' ) ) {
	...
	class WPSEO_Local_Admin_General_Settings {
		...
		public function opening_hours() {
			WPSEO_Local_Admin_Page::section_before( 'opening-hours-container' );
		...
		public function advanced() {
			...
			WPSEO_Local_Admin_Page::section_before( 'wpseo-local-custom-marker', null, 'wpseo-local-custom-marker-wrapper' );
			...
			echo '<img src="' . ( isset( $this->options['custom_marker'] ) ? wp_get_attachment_url( $this->options['custom_marker'] ) : '' ) . '" id="custom_marker" class="wpseo-local-hide-button' . ( ( false == $show_marker ) ? ' hidden' : '' ) . '">';
