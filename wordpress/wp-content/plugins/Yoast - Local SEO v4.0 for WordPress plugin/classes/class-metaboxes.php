		...
		function add_mce_popup() {
			...
			<script>
				function WPSEO_InsertMap() {
					...
					window.send_to_editor("[wpseo_map " + id + term + center + " width=\"" + width + "\" height=\"" + height + "\" zoom=\"" + zoom + "\" map_style=\"" + map_style + "\"" + scrollable + draggable + show_route + show_state + show_country + show_url + show_email + show_category_filter + default_show_infowindow + "]");
				}
				function WPSEO_InsertAddress() {
					...
					window.send_to_editor("[" + shortcode_name + " " + id + term + hide_name + hide_address + oneline + show_state + show_country + show_phone + show_phone_2 + show_fax + show_email + show_url + show_vat + show_tax + show_coc + show_logo + show_opening_hours + hide_closed + comment + orderby + order + "]");
				}
				...
				function WPSEO_InsertStorelocator() {
					...
					window.send_to_editor("[wpseo_storelocator " + show_map + scrollable + draggable + show_radius + show_nearest_suggestion + radius + show_filter + " map_style=\"" + map_style + "\"" + oneline + show_state + show_country + show_phone + show_phone_2 + show_fax + show_email + show_url + show_opening_hours + hide_closed + show_category_filter + "]");
				}
